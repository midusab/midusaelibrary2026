...
export const PolicyModal: React.FC<PolicyModalProps> = ({
    ...
    refund: {
      ...
      body: (
        <div className="space-y-4 text-sm text-slate-600 font-body leading-relaxed">
          <p>
            At <strong className="text-slate-900">MidusaElibrary</strong>, we stand behind the quality and formatting of every digital eBook in our curated collection.
          </p>

          <h4 className="font-heading font-bold text-slate-900 text-base">1. Instant Download Guarantee</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">2. 24-Hour Money-Back Policy</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">3. How to Request a Refund</h4>
          <p>
            Simply send your M-Pesa Confirmation Code (e.g. <code className="bg-slate-200 text-dodgerblue px-1.5 py-0.5 rounded">QK89XLP20A</code>) to <strong className="text-dodgerblue">support@midusaelibrary.com</strong> or message our 24/7 WhatsApp desk. Refunds are processed back to the originating M-Pesa number within 2 hours.
          </p>
        </div>
      ),
    },
    privacy: {
      ...
      body: (
        <div className="space-y-4 text-sm text-slate-600 font-body leading-relaxed">
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">1. Information We Collect</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">2. Zero Third-Party Selling or Spam</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">3. Payment Security & Encryption</h4>
          <p>
    ...
    terms: {
      ...
      body: (
        <div className="space-y-4 text-sm text-slate-600 font-body leading-relaxed">
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">1. Personal Use License</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">2. Non-Commercial Restriction</h4>
          <p>
          ...
          <h4 className="font-heading font-bold text-slate-900 text-base">3. Lifetime Access</h4>
          <p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-50/80 backdrop-blur-md animate-fadeIn">
      ...
      <div className="relative w-full max-w-xl bg-slate-50 border border-slate-200 rounded-2xl shadow-2xl overflow-hidden z-10 text-slate-800 animate-slideDown">
        
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-100/80">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-dodgerblue/10 text-dodgerblue flex items-center justify-center">
              <IconComponent className="w-5 h-5" />
            </div>
            <div>
              <h3 className="font-heading font-bold text-lg text-slate-900">{content.title}</h3>
              <div className="flex items-center gap-1.5 text-xs text-dodgerblue font-medium">
        ...
        {/* Footer */}
        <div className="px-6 py-3.5 bg-slate-100/90 border-t border-slate-200 flex items-center justify-between">
          <span className="text-xs text-slate-500 font-mono">Midusa Trust Standard</span>
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-xl bg-dodgerblue hover:bg-dodgerblue text-white text-xs font-semibold transition-colors cursor-pointer"
          >
            Close & Understand
          </button>
        </div>

...
export const WishlistDrawer: React.FC<WishlistDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden font-sans text-slate-100">
      <div 
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex">
        <div className="w-screen max-w-md bg-[#0F172A] border-l border-slate-800 shadow-2xl flex flex-col h-full z-50 animate-slideLeft">
          ...
          {wishlistBooks.length === 0 ? (
            <div className="flex-1 p-6 flex flex-col items-center justify-center text-center space-y-4">
              <div className="w-16 h-16 rounded-3xl bg-slate-800/80 text-pink-400/60 flex items-center justify-center">
              ...
              {wishlistBooks.map((book) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded uppercase font-mono">
                      {book.category}
                    </span>

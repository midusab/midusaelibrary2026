...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      ...
      <div className="relative w-full max-w-md bg-[#0F172A] border border-slate-800 rounded-3xl shadow-2xl overflow-hidden z-10 text-slate-100 animate-slideDown">
        
        {/* Header */}
        <div className="p-6 sm:p-8 text-center border-b border-slate-800 relative bg-linear-to-b from-slate-900 to-slate-950">
          <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8 space-y-5">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/80 text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-3 transition-colors cursor-pointer"
          >
          ...
          <form onSubmit={handleMpesaQuickLogin} className="space-y-4">
            {authMode === 'register' && (
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs sm:text-sm placeholder-slate-500 focus:outline-hidden focus:border-blue-500"
                />
              </div>
            )}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs sm:text-sm placeholder-slate-500 focus:outline-hidden focus:border-blue-500"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs sm:text-sm shadow-md shadow-blue-500/20 flex items-center justify-center gap-2 transition-transform active:scale-98 cursor-pointer"
            >
